import "./EwabeyBot.css";
import { useEffect } from "react";
import gsap from "gsap";
import Button from "@mui/material/Button";
import { useNavigate } from "react-router-dom"
import { ToastContainer, toast, Bounce as ToastBounce } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

export default function EwabeyBot() {
  ...
  const handleNotification = async () => {
    toast.info(
      `I'm building project for my client. To create your project click on the below button and my executive will reach out to you for consultation.`,
      {
        position: "top-center",
        autoClose: 10000,
  ...
  return (
    ...
    >
      <div className="svg-box" style={{ backgroundColor: "inherit" }}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
          ...
          <g id="Ship">
            ...
            <g id="robot" onClick={handleNotification}>
              <path
                id="body-base"
                fill="#fff"
                d="M490.4 368.3c0 63.7-38 140-84.7 140s-84.8-76.3-84.8-140 38-90.6 84.8-90.6 84.7 26.9 84.7 90.6z"
